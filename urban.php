...
$stmt1 = $db->prepare('SELECT * FROM colleges WHERE colleges.college_id=9');
$stmt1->execute();
...
<body> 
	...
	<div id="rightnav">
	<ul id="nav">
	<li class="current urban_nav"><a href="#urbanaffairs" ></a></li>
	<li class="urban_nav"><a href="#urbanaffairs_departments" ></a></li>
	</ul>
	<div id="arrow">
