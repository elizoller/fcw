...
$stmt1 = $db->prepare('SELECT * FROM colleges WHERE colleges.college_id=10');
$stmt1->execute();
...
<body> 
	...
	<div id="rightnav">
	<ul id="nav">
	<li class="current urban_nav"><a href="#libraries" ></a></li>
	<li class="urban_nav"><a href="#libraries_departments" ></a></li>
	</ul>
	<div id="arrow">
    ...
    <!-- Section #1 -->
	<section id="libraries" data-speed="6" data-type="background">
			<h1 class='libraries collegehome text-center'><?php echo $college_name; ?></h1>
	</section>
	<!-- Section #2 -->
	<section id="libraries_departments" data-speed="4" data-type="background">
		<div class="row">
