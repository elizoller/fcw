...
$stmt1 = $db->prepare('SELECT * FROM colleges WHERE colleges.college_id=8');
$stmt1->execute();
...
<body> 
	...
	<div id="rightnav">
	<ul id="nav">
	<li class="current arch_nav"><a href="#socialwork" ></a></li>
	<li class="arch_nav"><a href="#socialwork_departments" ></a></li>
	</ul>
	<div id="arrow">
    ...
    <!-- Section #1 -->
	<section id="socialwork" data-speed="6" data-type="background">
			<h1 class='socialwork collegehome text-center'><?php echo $college_name; ?></h1>
	</section>
	<!-- Section #2 -->
	<section id="socialwork_departments" data-speed="4" data-type="background">
		<div class="row">
